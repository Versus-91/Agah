...
using AFIAT.TST.Web.Chat.SignalR;
using AFIAT.TST.Web.Common;
using Swashbuckle.AspNetCore.Swagger;
using AFIAT.TST.Web.IdentityServer;
using AFIAT.TST.Web.Swagger;
using Stripe;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() {Title = "TST API", Version = "v1"});
            ...
            return services.AddAbp<TSTWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "TST API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("AFIAT.TST.Web.wwwroot.swagger.ui.index.html");
