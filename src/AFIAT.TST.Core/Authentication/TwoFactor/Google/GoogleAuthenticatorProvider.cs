...
namespace AFIAT.TST.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : TSTServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("AFIAT.TST", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
