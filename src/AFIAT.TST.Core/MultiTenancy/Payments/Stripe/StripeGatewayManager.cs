...
{
    public class StripeGatewayManager : TSTServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "TST";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + TSTConsts.Currency;
        }
